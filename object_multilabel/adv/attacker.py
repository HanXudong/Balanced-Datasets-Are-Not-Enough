...
def generate_image_feature(split, image_features_path, data_loader, encoder):
    ...
    for ind, (images_, targets_, genders_, image_ids_) in enumerate(data_loader):
        ...
        # image_features.append(adv_preds.cpu())
...
def test(args, model, data_loader):
    ...
    print('Test epoch   :, meanAP: {:.2f}, f1 score: {:.2f}, adv acc: {:.2f}, '.format( \
        meanAP*100, task_f1_score*100, adv_acc*100))
...
def main():
    ...
    #Build the encoder
    encoder = ObjectMultiLabelAdv(args, args.num_object, args.adv_capacity, args.dropout, \
